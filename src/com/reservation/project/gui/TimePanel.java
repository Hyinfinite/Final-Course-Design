...
public class TimePanel extends JPanel {
    ...
    private void addDateTimeCombo(JPanel p, JComboBox<String> y, JComboBox<String> mo, JComboBox<String> d,
        ...
        p.add(y);  p.add(new JLabel("年"));   // 添加年份下拉框和"年"标签
        p.add(mo); p.add(new JLabel("月"));   // 添加月份下拉框和"月"标签
        p.add(d);  p.add(new JLabel("日"));   // 添加日期下拉框和"日"标签
        p.add(h);  p.add(new JLabel("时"));   // 添加小时下拉框和"时"标签
        p.add(mi); p.add(new JLabel("分"));   // 添加分钟下拉框和"分"标签
    }
